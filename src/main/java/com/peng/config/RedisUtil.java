...
public class RedisUtil extends CachingConfigurerSupport {
    ...
    public Object executeScript(String script,List<String> keyList,List<String> args){
    	DefaultRedisScript<Object> getRedisScript = new DefaultRedisScript<Object>();
        getRedisScript.setScriptText(script);
        return stringRedisTemplate.execute(getRedisScript,keyList, args);
    }
